...
RenderTexture3D::~RenderTexture3D()
{
	// _depthStencilTexture->getBackendTexture() can be cought by the objects which are rendering to it when shadow is used
...
//	_endCommand.init(_globalZOrder, _transformMatrix, Node::FLAGS_RENDER_AS_3D);
